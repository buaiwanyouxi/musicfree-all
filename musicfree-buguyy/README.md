...
将 [布谷音乐](https://cdn.jsdelivr.net/gh/buaiwanyouxi/musicfree-all@main/musicfree-buguyy/buguyy.js)（在线音乐试听与无损音乐下载平台）适配为 MusicFree 插件。
...
1. 复制 raw 链接：`https://cdn.jsdelivr.net/gh/buaiwanyouxi/musicfree-all@main/musicfree-buguyy/buguyy.js`
